...
Std_ReturnType ecu_button_read_state(const button_config_t* _btn_config, button_state_t* btn_state)
{
    ...
    if(((void*)0) == _btn_config || ((void*)0) == btn_state)
    {
        ret = (Std_ReturnType)0x00;
    }
