 ...
 * @note   ADC_CONVERTER_DISABLE() : Disable the Analog-To-Digital
 ...
 * @note   ADC_DISABLE_VOLTAGE_REFERENCE() : Voltage Reference is VSS & VDD
 *         ADC_ENABLE_VOLTAGE_REFERENCE()  : Voltage Reference is VREF-(AN2 pin) & VREF+(AN3 pin)
 */
