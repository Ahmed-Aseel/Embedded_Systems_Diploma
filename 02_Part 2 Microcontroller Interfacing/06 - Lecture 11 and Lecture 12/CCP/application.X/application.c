...
{
    /* square wave 20Hz duty 75% ----> OFF */
    ret = mcal_CCP_Compare_Mode_Set_Value(&ccp1_obj, 37500);
...
void CCP1_App_ISR(void)
{
    ...
    if(1 == ccp1_flag)
    {
        /* square wave 20Hz duty 25% ----> ON */
        ret = mcal_CCP_Compare_Mode_Set_Value(&ccp1_obj, 12500);        
    }
    else
    {
        /* square wave 20Hz duty 75% ----> OFF */
