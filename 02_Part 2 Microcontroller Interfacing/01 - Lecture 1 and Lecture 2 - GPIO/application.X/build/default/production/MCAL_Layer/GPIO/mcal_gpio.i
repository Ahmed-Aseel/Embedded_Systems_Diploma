...
# 33 "MCAL_Layer/GPIO/mcal_gpio.h"
typedef enum {
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t;
...
# 8 "MCAL_Layer/GPIO/mcal_gpio.c" 2



volatile Std_ReturnType* tris_registers[] = {&TRISA, &TRISB, &TRISC, &TRISD, &TRISE};

volatile Std_ReturnType* lat_registers[] = {&LATA, &LATB, &LATC, &LATD, &LATE};

volatile Std_ReturnType* port_registers[] = {&PORTA, &PORTB, &PORTC, &PORTD, &PORTE};
# 25 "MCAL_Layer/GPIO/mcal_gpio.c"
Std_ReturnType gpio_pin_direction_initialize(const pin_config_t* _pin_config)
{
    Std_ReturnType ret = (Std_ReturnType)0x01;

    if(((void*)0) == _pin_config || _pin_config->pin > 7)
    {
    ...
    else
    {
        switch(_pin_config->direction)
        {
            case GPIO_DIRECTION_OUTPUT:
                (*tris_registers[_pin_config->port] &= ~((Std_ReturnType)1 << _pin_config->pin));
                break;
...
Std_ReturnType gpio_pin_direction_status(const pin_config_t* _pin_config, direction_t* direction_status)
{
    ...
    if(((void*)0) == _pin_config || ((void*)0) == direction_status || _pin_config->pin > 7)
    {
        ret = (Std_ReturnType)0x00;
    }
    ...
    {
        *direction_status = ((*tris_registers[_pin_config->port] >> _pin_config->pin) & (Std_ReturnType)1);
    }
...
Std_ReturnType gpio_pin_write_logic(const pin_config_t* _pin_config, logic_t logic)
{
    ...
    else
    {
       switch(logic)
        {
            case GPIO_LOW:
                (*lat_registers[_pin_config->port] &= ~((Std_ReturnType)1 << _pin_config->pin));
                break;
...
Std_ReturnType gpio_pin_read_logic(const pin_config_t* _pin_config, logic_t* logic)
{
    ...
    if(((void*)0) == _pin_config || ((void*)0) == logic || _pin_config->pin > 7)
    {
        ret = (Std_ReturnType)0x00;
    }
    ...
    {
        *logic = ((*port_registers[_pin_config->port] >> _pin_config->pin) & (Std_ReturnType)1);
    }
...
# 185 "MCAL_Layer/GPIO/mcal_gpio.c"
Std_ReturnType gpio_port_direction_initialize(port_index_t port, Std_ReturnType direction)
{
    Std_ReturnType ret = (Std_ReturnType)0x01;
...
Std_ReturnType gpio_port_direction_status(port_index_t port, Std_ReturnType* direction_status)
{
    ...
    if(((void*)0) == direction_status || port > 4)
    {
        ret = (Std_ReturnType)0x00;
    }
...
Std_ReturnType gpio_port_toggle_logic(port_index_t port)
{
    ...
    {
        *lat_registers[port] ^= (Std_ReturnType)0xFF;
    }
