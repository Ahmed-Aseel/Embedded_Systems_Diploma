...
extern lcd_8bits_config_t lcd_2;
...
# 45 "application.c"
    ...
    {
# 94 "application.c"
        ret = ecu_lcd_8bits_send_custom_char(&lcd_2, 1, 20, customchar1, 0);
        _delay((unsigned long)((250)*(4000000UL/4000.0)));
        ret = ecu_lcd_8bits_send_custom_char(&lcd_2, 1, 20, customchar2, 0);
        _delay((unsigned long)((250)*(4000000UL/4000.0)));
        ret = ecu_lcd_8bits_send_custom_char(&lcd_2, 1, 20, customchar3, 0);
        _delay((unsigned long)((250)*(4000000UL/4000.0)));
        ret = ecu_lcd_8bits_send_custom_char(&lcd_2, 1, 20, customchar4, 0);
        _delay((unsigned long)((250)*(4000000UL/4000.0)));
        ret = ecu_lcd_8bits_send_custom_char(&lcd_2, 1, 20, customchar5, 0);
        _delay((unsigned long)((250)*(4000000UL/4000.0)));
        ret = ecu_lcd_8bits_send_custom_char(&lcd_2, 1, 20, customchar6, 0);
        _delay((unsigned long)((250)*(4000000UL/4000.0)));
    }
