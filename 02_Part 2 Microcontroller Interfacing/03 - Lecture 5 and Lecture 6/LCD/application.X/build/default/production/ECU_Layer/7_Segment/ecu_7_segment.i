...
# 1 "ECU_Layer/7_Segment/ecu_7_segment_cfg.h" 1
# 12 "ECU_Layer/7_Segment/ecu_7_segment.h" 2

# 1 "ECU_Layer/7_Segment/../../MCAL_Layer/GPIO/mcal_gpio.h" 1
# 12 "ECU_Layer/7_Segment/../../MCAL_Layer/GPIO/mcal_gpio.h"
...
# 12 "ECU_Layer/7_Segment/../../MCAL_Layer/GPIO/mcal_gpio.h" 2
...
# 13 "ECU_Layer/7_Segment/../../MCAL_Layer/GPIO/mcal_gpio.h" 2

# 1 "ECU_Layer/7_Segment/../../MCAL_Layer/GPIO/../device_config.h" 1
# 14 "ECU_Layer/7_Segment/../../MCAL_Layer/GPIO/mcal_gpio.h" 2

# 1 "ECU_Layer/7_Segment/../../MCAL_Layer/GPIO/mcal_gpio_cfg.h" 1
# 15 "ECU_Layer/7_Segment/../../MCAL_Layer/GPIO/mcal_gpio.h" 2
# 33 "ECU_Layer/7_Segment/../../MCAL_Layer/GPIO/mcal_gpio.h"
typedef enum {
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t;
...
# 13 "ECU_Layer/7_Segment/ecu_7_segment.h" 2
# 24 "ECU_Layer/7_Segment/ecu_7_segment.h"
typedef enum {
...
Std_ReturnType ecu_7_segment_initialize(const segment_config_t* _segment_config)
{
    ...
    {
        ret = gpio_pin_initialize(&_segment_config->segment_pins[0]);
        ret = gpio_pin_initialize(&_segment_config->segment_pins[1]);
        ret = gpio_pin_initialize(&_segment_config->segment_pins[2]);
        ret = gpio_pin_initialize(&_segment_config->segment_pins[3]);
    }
...
Std_ReturnType ecu_7_segment_write_number(const segment_config_t* _segment_config, uint8 number)
{
    ...
    if(((void*)0) == _segment_config && number > 9)
    {
        ret = (Std_ReturnType)0x00;
    }
    ...
    {
        ret = gpio_pin_write_logic(&_segment_config->segment_pins[0], number & 0x01);
        ret = gpio_pin_write_logic(&_segment_config->segment_pins[1], (number >> 1) & 0x01);
        ret = gpio_pin_write_logic(&_segment_config->segment_pins[2], (number >> 2) & 0x01);
        ret = gpio_pin_write_logic(&_segment_config->segment_pins[3], (number >> 3) & 0x01);
    }
