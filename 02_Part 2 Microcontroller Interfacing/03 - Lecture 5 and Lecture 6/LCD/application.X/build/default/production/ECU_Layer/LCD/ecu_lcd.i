...
# 1 "C:/Program Files/Microchip/MPLABX/v6.05/packs/Microchip/PIC18Fxxxx_DFP/1.3.36/xc8\\pic\\include\\proc\\../pic18.h" 1 3
...
Std_ReturnType ecu_lcd_4bits_initialize(const lcd_4bits_config_t* _lcd_4bits_config)
{
    ...
    else
    {
        ...
        ret = ecu_lcd_4bits_send_command(_lcd_4bits_config, 0x38);
        _delay((unsigned long)((5)*(4000000UL/4000.0)));
        ret = ecu_lcd_4bits_send_command(_lcd_4bits_config, 0x38);
        _delay((unsigned long)((150)*(4000000UL/4000000.0)));
        ret = ecu_lcd_4bits_send_command(_lcd_4bits_config, 0x38);

        ret = ecu_lcd_4bits_send_command(_lcd_4bits_config, 0x01);
        ret = ecu_lcd_4bits_send_command(_lcd_4bits_config, 0x02);
        ret = ecu_lcd_4bits_send_command(_lcd_4bits_config, 0X06);
        ret = ecu_lcd_4bits_send_command(_lcd_4bits_config, 0x0C);
        ret = ecu_lcd_4bits_send_command(_lcd_4bits_config, 0x28);
        ret = ecu_lcd_4bits_send_command(_lcd_4bits_config, 0x80);
    }
...
Std_ReturnType ecu_lcd_4bits_send_string(const lcd_4bits_config_t* _lcd_4bits_config, uint8* str)
{
    ...
    if(((void*)0) == _lcd_4bits_config || ((void*)0) == str)
    {
        ret = (Std_ReturnType)0x00;
    }
                                              ...
                                              const uint8 _char[], uint8 mem_pos)
{
    ...
    if(((void*)0) == _lcd_4bits_config || ((void*)0) == _char)
    {
        ret = (Std_ReturnType)0x00;
    }
    ...
    {
        ret = ecu_lcd_4bits_send_command(_lcd_4bits_config, (0x40 + (mem_pos * 8)));
...
Std_ReturnType ecu_lcd_8bits_initialize(const lcd_8bits_config_t* _lcd_8bits_config)
{
    ...
    else
    {
        ...
        _delay((unsigned long)((20)*(4000000UL/4000.0)));
        ret = ecu_lcd_8bits_send_command(_lcd_8bits_config, 0x38);
        _delay((unsigned long)((5)*(4000000UL/4000.0)));
        ret = ecu_lcd_8bits_send_command(_lcd_8bits_config, 0x38);
        _delay((unsigned long)((150)*(4000000UL/4000000.0)));
        ret = ecu_lcd_8bits_send_command(_lcd_8bits_config, 0x38);

        ret = ecu_lcd_8bits_send_command(_lcd_8bits_config, 0x01);
        ret = ecu_lcd_8bits_send_command(_lcd_8bits_config, 0x02);
        ret = ecu_lcd_8bits_send_command(_lcd_8bits_config, 0X06);
        ret = ecu_lcd_8bits_send_command(_lcd_8bits_config, 0x0C);
        ret = ecu_lcd_8bits_send_command(_lcd_8bits_config, 0x38);
        ret = ecu_lcd_8bits_send_command(_lcd_8bits_config, 0x80);
    }
...
Std_ReturnType ecu_lcd_8bits_send_string(const lcd_8bits_config_t* _lcd_8bits_config, uint8* str)
{
    ...
    if(((void*)0) == _lcd_8bits_config || ((void*)0) == str)
    {
        ret = (Std_ReturnType)0x00;
    }
                                              ...
                                              const uint8 _char[], uint8 mem_pos)
{
    ...
    if(((void*)0) == _lcd_8bits_config || ((void*)0) == _char)
    {
        ret = (Std_ReturnType)0x00;
    }
    ...
    {
        ret = ecu_lcd_8bits_send_command(_lcd_8bits_config, (0x40 + (mem_pos * 8)));
